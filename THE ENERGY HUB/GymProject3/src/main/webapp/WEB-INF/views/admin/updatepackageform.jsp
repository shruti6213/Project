...
<form:form  method="post" modelAttribute="update_Package">
	...
	<br />
			...
			<div class="row align-items-start">
				...
				<div class="col">
					<form:input path="packageName" value="${requestScope.packageName }" required="required" />
				</div>
			</div>
			...
			<div class="row align-items-start">
				...
				<div class="col">
					<form:input path="amount" value="${requestScope.amount }" required="required"/>
				</div>
			</div>
	...
	<br />
			...
			<div class="row align-items-start">
				...
				<div class="col">
					<form:input path="duration" value="${requestScope.duration }" required="required"/>
				</div>
			</div>
